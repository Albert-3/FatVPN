...
@objc class AppDelegate: FlutterAppDelegate, FlutterImplicitEngineDelegate {
  ...
  /// Mirrors the session into the home-screen widget, and hands Dart the link a
  /// widget press arrives as.
  ///
  ...
  private static func attachWidgetChannel(
  ...
  ///
  /// Nothing on this build parks one — the widget's press is a link on every
  /// version of iOS now, and links arrive through `rememberLaunchLink`, which
  /// posts the same nudge. This stays for the press an *older* build may have
  /// left in the App Group before the update: without it that action would sit
  /// there until the user backgrounded and reopened the app.
