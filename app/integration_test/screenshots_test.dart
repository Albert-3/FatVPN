...
void main() {
  ...
  testWidgets('store screenshots', (t) async {
    ...
    await _waitFor(t, find.byIcon(Icons.power_settings_new), 'the home screen');
    // Let the server list land so the card names a location, not a spinner.
    ...
    await binding.takeScreenshot('05-split-tunneling');
  });
}
